...
trojanlink="trojan-go://${user}@${sts}${domain}:${trgows}?type=standard&sni=$sni&path=$patch&encryption=none#reyzvpn@${user}"
trojanlinkws="trojan-go://${user}@${sts}${domain}:${trgows}/?sni=$sni&type=ws&host=$sni&path=$patch&encryption=none#reyzvpn@${user}"
clear
echo -e "\e[$line════════[▫️TROJAN GO▫️]════════\e[m"
echo -e "Remarks  : ${user}"
echo -e "Domain   : ${domain}"
echo -e "IP/Host  : ${MYIP}"
echo -e "Port     : ${trgows}"
...
trojanlinkws="trojan-go://${user}@${sts}${domain}:${trgows}/?sni=$sni&type=ws&host=$sni&path=$patch&encryption=none#reyzvpn@${user}"
clear
echo -e "\e[$line═════[▫️TRIAL TROJAN GO▫️]═════\e[m"
echo -e "Remarks  : ${user}"
echo -e "Domain   : ${domain}"
echo -e "IP/Host  : ${MYIP}"
echo -e "Port     : ${trgows}"
...
exp=$(grep -E "^### " "/etc/trojan-go/akun.conf" | cut -d ' ' -f 3 | sed -n "${CLIENT_NUMBER}"p)
uuid=$(grep -E "^### " "/etc/trojan-go/akun.conf" | cut -d ' ' -f 5 | sed -n "${CLIENT_NUMBER}"p)
trojanlink="trojan-go://${user}@${sts}${domain}:${trgows}?type=standard&sni=$sni&path=$patch#reyzvpn@${user}"
trojanlinkws="trojan-go://${user}@${sts}${domain}:${trgows}/?sni=$sni&type=ws&host=$sni&path=$patch&encryption=none#reyzvpn@${user}"
clear
echo -e "\e[$line════════[▫️TROJAN GO▫️]════════\e[m"
echo -e "Remarks  : ${user}"
