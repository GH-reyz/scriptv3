...
echo -e  "   Trojan    :\e[m \e[$below $totaltr Account "
echo -e  "   Vless     :\e[m \e[$below $totalvl Account "
echo -e  "   Trojan-GO :\e[m \e[$below $totalgo Account "
echo -e   " \e[$line─────────────────────────────────────────────────────────────────\e[m"
...
echo -e   " \e[$line└───────────────────────────────────────────────────────────────┘\e[m"
echo -e   "  \e[$number│ Client Name   :\e[m \e[$below $username                               │${NC}"
echo -e   "  \e[$number│ Script Status :\e[m \e[$below $exp\e[m $sts                           │${NC}"
echo -e   "  \e[$number│ AutoScript By :\e[m \e[$below @GHReyz                                 │${NC}"
echo -e   " \e[$line└───────────────────────────────────────────────────────────────┘\e[m"
echo -e   ""
