...
echo -e   " \e[$line═════════════════════════════════════════════════════════════════\e[m"
echo -e  "  \e[$number Ssh/Ovpn  :\e[m \e[$below $total_ssh \e[m  \e[$number VlessTcp  :\e[m \e[$below $totaltcp \e[m"
echo -e  "  \e[$number Vmess     :\e[m \e[$below $totalvm   \e[m  \e[$number Trojan    :\e[m \e[$below $totaltr \e[m"
echo -e  "  \e[$number Vless     :\e[m \e[$below $totalvl   \e[m  \e[$number Trojan-GO :\e[m \e[$below $totalgo \e[m"
echo -e   " \e[$line═════════════════════════════════════════════════════════════════\e[m"
